...
wh*可以找到white和why,但找不到wash和without

?

通配任意单个字符

b?11可以找到ball和bill,但找不到blle和beall

[]

通配方括号内任意单个字符

b[al]lI可以找到ball和bell,但找不到bill

通配任意不在括号内的字符

b[!ae]1可以找到bill和bull,但找不到bell和ball

通配范围内的任意-一个字符

b[a-c]d可以找到bad、bbd 和bcd,但找不到bdd

#

通配任意单个数字字符

1#3可以找到103、113 和123，但找不到1a3
